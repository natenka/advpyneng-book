...
Основу класса Topology можно взять из любого задания 1.1x или задания 2.1.
...
Добавить к классу CiscoTelnet из задания 1.2x поддержку работы в менеджере контекста.
...
.. code-block:: python
    ...
    In [15]: from task_2_2 import CiscoTelnet
